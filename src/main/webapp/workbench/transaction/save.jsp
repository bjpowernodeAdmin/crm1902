...
<script>
	...
	$(function () {
		...
		$("#create-stage").change(function () {
			...
			//为了取得阶段对应的可能性，我们还需要有一个阶段和可能性的对应关系
			//有了对应关系之后，通过阶段，取得对应的可能性就行了
			//我们现在有阶段和可能性的对应关系，在服务器缓存中pMap，但是pMap是java语言的
			//需要将java中的键值对关系pMap，转换成为js中的键值对关系json
			//我们的key（stage）这一次是动态的变量，如果是这样的key，就不能以传统形式json.key的形式来取得value
			//我们需要以json[key]的形式来取得value
	...
	<form action="workbench/transaction/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="3bf14f7e119f4afe8e8fd6d3a8e5e602" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="f8943aa4a8e04e558aff26dedef4290c" name="contactsId"/>
			</div>
		</div>
